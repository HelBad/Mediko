                ...
                if (response.code() == 200) {
                    response.body().let {
                        if (it != null) {
                            ...
                            adapter.setOnItemEditCallback(object :
                                OnItemActionCallback {
                            ...
                            adapter.setOnItemDeleteCallback(object :
                                OnItemActionCallback {
                                override fun onItemAction(data: Any) { TODO("Not yet implemented") }
                            })
